...
<div id="wrapper">
    ...
    <div id="main">
        ...
        <table border="1" style="background-color: white; color:black">
            ...
            if ($query) {
                $stmt = $conn->prepare("SELECT * FROM hall WHERE hallName LIKE ? ORDER BY hallName ASC");
                $searchQuery = "%" . $query . "%";
                $stmt->bind_param("s", $searchQuery);
            } else {
                $stmt = $conn->prepare("SELECT * FROM hall ORDER BY hallName ASC");
            }
            ...
            ?>
                        ...
                        <tr>
                            ...
                            <td align="center"><a href="hall_update.php?hallID=<?php echo $row['hallID']; ?>"> Update</a></td>
                            <td align="center"><a href="hall_delete.php?hallID=<?php echo $row['hallID']; ?>" onclick="return checkdelete()"> Delete</a></td>
                        </tr>
